function [y, u, u_rms, u_power, ut, nu, y0, k, B, PI, d, d_star, theta,...
    H, up_model, yp_model] = hotwireProcessor(dataFile, calFile, wallFile,...
    ignore)
...
% Store data
% -------------------------------------------------------------------------
save([dataFile(1:end-4) '.mat'], 'y', 'u', 'u_rms', 'u_power', 'ut', 'nu', ...
